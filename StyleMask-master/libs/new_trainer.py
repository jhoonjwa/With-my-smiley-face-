...
class new_Trainer(object):
	...
	def initialize_arguments(self, args):
		...
		self.train_image = args['train_path']           ###where the asian dataset will be stored
    ...
    ##how to load models. it still stands for the inversion case, so don't touch it unless you need to
